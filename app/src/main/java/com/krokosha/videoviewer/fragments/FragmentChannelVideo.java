package com.krokosha.videoviewer.fragments;
...
import com.krokosha.videoviewer.R;
import com.krokosha.videoviewer.MySingleton;
import com.krokosha.videoviewer.adapters.AdapterList;
import com.krokosha.videoviewer.utils.Utils;
...
public class FragmentChannelVideo extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mUltimateRecyclerView.setOnLoadMoreListener(onLoadMoreListener);
        ...
        new Utils.syncShowAd(getActivity().getApplicationContext()).execute();
        getVideoData();
        return view;
    }
    ...
    private ItemTouchListenerAdapter.RecyclerViewOnItemClickListener onItemClickListener =
...
//    @Override
//    public void onClick(View view) {rr
//        switch (view.getId()) {
//            case R.id.raisedRetry:
//                mPrgLoading.setVisibility(View.VISIBLE);
//                haveResultView();
